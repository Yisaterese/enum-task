...
export const InstructionList =[
    ...
    'Once test has begun, you cannot go back as you would be forced to submit.',
    'Once you have submitted an answer, you can’t go back.',
...
export const ProgramImageList=[
    [ image1, logo1, "Business Management", '₦3,000,600 '],
    [ image2, logo1, "Business Management", "Free"],
    [ image1, logo2, "Business Management", '₦3,000,600 '],
    [ image3, logo2, "Business Management", '₦3,000,600 '],
    [ image4, logo3, "Business Management", "Free"],
    [ image5, logo1, "Business Management", '₦3,000,600 '],
    [ image6, logo2, "Business Management", '₦3,000,600 '],
    [ image7, logo1, "Business Management", '₦3,000,600 '],
    [ image8, logo3, "Business Management", "Free"],
    [ image1, logo3, "Business Management", "Free"],
    [image9, logo1, "Business Management", "Free"],
