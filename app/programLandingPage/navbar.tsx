        ...
        <div className='p-3'>
            <div className='flex justify-between mt-1 ml-[4%] mr-[4%] mb-5 '>
                ...
                <div className='relative flex items-center'>
                    ...
                    <input type="text" placeholder={'Search' } className=" p-1.5 pl-10 ml-[280px] pr-[120px] border rounded-lg"/>
                </div>
                <div className='flex pl-[160px]'>
                    ...
                    <Icon icon="prime:chevron-down" className={'m-[6px] '} style={{color: '#292e48'}} width={35} height={35}/>
                </div>
            </div>
        </div>
    );
