                                ...
                                <div className={'flex'}>
                                    ...
                                    <div className={'ml-10 mt-[45px] w-full text-black'}>
                                        <div className='flex p-2 p-3 pl-0 text-black rounded-lg border-2 mb-3'>
                                            ...
                                            <Button word={'4 '} className='w-[32px] h-[18px] font-[400] text-[14px] leading-[24px]' />
                                        </div>
                                        <div className='flex p-2 pl-0 text-black rounded-lg border-2 mb-3'>
                                            <Image src={letterB} alt={'letterB'} className={'w-[24px] ml-2 h-[24px] text-black'} />
                                            <Button word={'6 '} className='w-[32px] h-[18px] font-[400] text-[14px] leading-[24px]' />
                                        </div>
                                        <div className='flex p-2 pl-0 text-black rounded-lg border-2 mb-3'>
