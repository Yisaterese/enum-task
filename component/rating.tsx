                    ...
                    <div className="p-6 bg-[#F6FCFF] h-[50%]">
                        <div>
                            ...
                            <div className={'flex gap-2'}>
                                ...
                                <p style={{textDecoration:'line-through', color:'#A7B5E'}}>₦1,200,000.00</p>
                            </div>
                            <button className={`bg-blue-500 text-white px-4 py-2 w-[100%] rounded hover:bg-blue-600  ${classname}`}>
                                {button}
                            </button>
                        </div>
                        <button className="text-xs mt-2 text-blue-500 px-4 py-2 w-[230px] rounded hover:bg-gray-300">
